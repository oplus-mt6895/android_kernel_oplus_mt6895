...
enum {
	...
	IRIS_DTSI1_PIP_IDX,
	IRIS_DTSI_PIP_IDX_END = IRIS_DTSI1_PIP_IDX,
	IRIS_LUT_PIP_IDX,
	IRIS_PIP_IDX_CNT,
...
struct iris_lp_ctrl {
	...
	bool abyp_enable;
	int esd_trigger;
	// bit [0]: iris esd check, [1]: panel esd check, [2]: recovery, [3]: print more informatio
	int esd_ctrl;
